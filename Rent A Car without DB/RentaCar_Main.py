from RentaCar import CarRent, BikeRent, Customer
bike = BikeRent(100)
car = CarRent(10)
customer = Customer()
main_menu = True
...
a
        if choice == 1:
            ...
            customer.rentalBasis_c, customer.rentalTime_c, customer.bikes = 0,0,0
            main_menu = True
            print("-----------------")
        ...
        main_menu = True
    print("Thank you for choosing vehicle rental shop")
